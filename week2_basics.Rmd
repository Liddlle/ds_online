...
Однако, мы редко имеем дело только с одной переменной, чаще для одного человека/предмета/страны... у нас есть несколько показателей (не только возраст, но и, например, пол), а объединяются в таблицы (составляющие их вектора должны быть одинаковой длины).
